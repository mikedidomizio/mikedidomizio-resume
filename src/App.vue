    ...
    <div id="app" class="wrap">
        ...
        <CVItem title="theScore" website="https://www.thescore.bet"
            ...
            <ul class="disc">
                ...
                <li>Added Datadog monitoring with Slack alerts for CI flakiness, raising potential application anomalies</li>
                <li>Created Datadog dashboards to monitor performance and ensure alignment with partnership SLO commitments</li>
        ...
        <CVItem title="Spoonity" website="https://www.spoonity.com/"
            ...
            <ul class="disc">
                ...
                <li>Server side PHP development for supporting consumer apps</li>
            </ul>
        </CVItem>
